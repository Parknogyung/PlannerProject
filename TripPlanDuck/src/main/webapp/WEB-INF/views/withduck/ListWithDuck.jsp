                ...
                <div class="col">
                    <div class="p-3 border bg-light">
                       ...
                       <c:if test="${ empty withDuck.reList[0] }">
                        ...
                        <div>
                         <p class="title" style="font-size: 18px; font-weight: bold; white-space: nowrap;text-overflow: ellipsis;overflow: hidden;">${withDuck.withTitle }</p>
                        </div>
                        <div style="height: 48px;"><p class="content">${withDuck.withContent }</p></div>
